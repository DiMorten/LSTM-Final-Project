...
if [ $mode -eq 6 ]; then
	...
	cd ../hanover_rnn_src/
	python main.py -mm="ram" --debug=1 -pl 5 -po 4 -ts 0 -tnl 90 -bs=30000 --batch_size=1000 --filters=256 -m="convlstm" --phase="train" -sc=True --class_n=8 --log_dir="../data/summaries/" --path="../hn_data/" --im_h=6231 --im_w=4548 --band_n=2 --t_len=24 --id_first=1 -psv=False -tof=False --epoch=200 -nap=2 -tmd="False" -tfld="/home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/normy/test_patches/" 
	mv predicted.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/normy/convlstm/predicted.npy
	mv labels.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/normy/convlstm/labels.npy
fi
if [ $mode -eq 7 ]; then
...
if [ $mode -eq 8 ]; then # Do mask invert; save on normy3B. CV
	echo "STARTING CONVLSTM FOR CAMPO VERDE"
	cd ../batched_rnn_src/

	python main.py -mm="ram" --debug=1 -pl 15 -po 0 -ts 0 -tnl 90 -bs=50000 --batch_size=128 --filters=256 -m="convlstm" --phase="train" -sc=True --class_n=10 --log_dir="../data/summaries/" --path="../cv_data/" --im_h=8492 --im_w=7995 --band_n=2 --t_len=7 --id_first=1 -psv=False -tof=False --epoch=200 -nap=2 -tmd="False" -tfld="/home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/${folder_patches}/test_patches/seq1/"
	...
	python main.py -mm="ram" --debug=1 -pl 15 -po 0 -ts 0 -tnl 90 -bs=50000 --batch_size=128 --filters=256 -m="convlstm" --phase="train" -sc=True --class_n=9 --log_dir="../data/summaries/" --path="../cv_data/" --im_h=8492 --im_w=7995 --band_n=2 --t_len=7 --id_first=8 -psv=False -tof=False --epoch=200 -nap=2 -tmd="True" -tfld="/home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/${folder_patches}/test_patches/seq2/"
	...
	python main.py -mm="ram" --debug=1 -pl 15 -po 0 -ts 0 -tnl 90 -bs=50000 --batch_size=128 --filters=256 -m="lstm" --phase="train" -sc=True --class_n=9 --log_dir="../data/summaries/" --path="../cv_data/" --im_h=8492 --im_w=7995 --band_n=2 --t_len=7 --id_first=8 -psv=False -tof=False --epoch=200 -nap=2 -tmd="False" -tfld="/home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/${folder_patches}/test_patches/seq2/"
	...
	echo "Started FCN Campo Verde"

	cd ../src/
	python main.py -mm="ram" --debug=1 -pl 32 -po 0 -ts 0 -tnl 10000 -bs=5000 --batch_size=200 --filters=256 -m="smcnn_semantic" --phase="repeat" -sc=False --class_n=12 --log_dir="../data/summaries/" --path="../cv_data/" --im_h=8492 --im_w=7995 --band_n=2 --t_len=7 --id_first=1 -tof=False -nap=10000 -psv=True

	cd ../../../sbsr/fcn_model/keras_time_semantic_fcn/

	python main.py -pl=32 -pstr=32 -psts=32 -path="../../../deep_learning/LSTM-Final-Project/cv_data/" -tl=7 -cn=12 -chn=2

	mv prediction.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/${folder}/fcn/seq1/labels.npy
	mv labels.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/${folder}/fcn/seq1/predicted.npy
	...
	#python main.py -pl=32 -pstr=32 -psts=32 -path="../../../deep_learning/LSTM-Final-Project/hn_data/" -tl=24 -cn=9 -chn=2

fi

if [ $mode -eq 9 ]; then  #Hanover fcn mask B


	echo "STARTING HANOVER CINVLSTM"
	cd ../hanover_rnn_src/
	python main.py -mm="ram" --debug=1 -pl 5 -po 4 -ts 0 -tnl 90 -bs=30000 --batch_size=1000 --filters=256 -m="convlstm" --phase="train" -sc=True --class_n=8 --log_dir="../data/summaries/" --path="../hn_data/" --im_h=6231 --im_w=4548 --band_n=2 --t_len=24 --id_first=1 -psv=False -tof=False --epoch=200 -nap=2 -tmd="False" -tfld="/home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/${folder_patches}/test_patches/" 
	mv predicted.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/${folder}/convlstm/predicted.npy
	mv labels.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/${folder}/convlstm/labels.npy


	python main.py -mm="ram" --debug=1 -pl 5 -po 4 -ts 0 -tnl 90 -bs=30000 --batch_size=1000 --filters=256 -m="lstm" --phase="train" -sc=True --class_n=8 --log_dir="../data/summaries/" --path="../hn_data/" --im_h=6231 --im_w=4548 --band_n=2 --t_len=24 --id_first=1 -psv=False -tof=False --epoch=200 -nap=2 -tmd="False" -tfld="/home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/${folder_patches}/test_patches/" 
	mv predicted.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/${folder}/lstm/predicted.npy
	mv labels.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/${folder}/lstm/labels.npy


	#python main.py -mm="ram" --debug=1 -pl 8 -po 0 -ts 0 -tnl 5000 -bs=5000 --batch_size=200 --filters=256 -m="smcnn_semantic" --phase="repeat" -sc=False --class_n=9 --log_dir="../data/summaries/" --path="../hn_data/" --im_h=6231 --im_w=4548 --band_n=2 --t_len=24 --id_first=1 -tof=False -nap=5000 -psv=True
