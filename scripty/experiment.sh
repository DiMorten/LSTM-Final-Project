...
if [ $mode -eq 4 ]; then
	...
	python main.py -mm="ram" --debug=1 -pl 15 -po 0 -ts 0 -tnl 90 -bs=50000 --batch_size=1000 --filters=256 -m="convlstm" --phase="train" -sc=True --class_n=10 --log_dir="../data/summaries/" --path="../cv_data/" --im_h=8492 --im_w=7995 --band_n=2 --t_len=7 --id_first=1 -psv=False -tof=False --epoch=200 -nap=2 -tmd="True" -tfld="/home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/test_patches/seq1/"
	mv predicted.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/convlstm/seq1/predicted.npy
	mv labels.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/convlstm/seq1/labels.npy

	python main.py -mm="ram" --debug=1 -pl 15 -po 0 -ts 0 -tnl 90 -bs=50000 --batch_size=1000 --filters=256 -m="convlstm" --phase="train" -sc=True --class_n=9 --log_dir="../data/summaries/" --path="../cv_data/" --im_h=8492 --im_w=7995 --band_n=2 --t_len=7 --id_first=8 -psv=False -tof=False --epoch=200 -nap=2 -tmd="True" -tfld="/home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/test_patches/seq2/"
	mv predicted.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/convlstm/seq2/predicted.npy
	mv labels.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/convlstm/seq2/labels.npy

	echo "SARTING LSTM FOR CAMPO VERDE"
	python main.py -mm="ram" --debug=1 -pl 15 -po 0 -ts 0 -tnl 90 -bs=50000 --batch_size=1000 --filters=256 -m="lstm" --phase="train" -sc=True --class_n=10 --log_dir="../data/summaries/" --path="../cv_data/" --im_h=8492 --im_w=7995 --band_n=2 --t_len=7 --id_first=1 -psv=False -tof=False --epoch=200 -nap=2 -tmd="False" -tfld="/home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/test_patches/seq1/"
	mv predicted.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/lstm/seq1/predicted.npy
	mv labels.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/lstm/seq1/labels.npy
	...
	mv predicted.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/lstm/seq2/predicted.npy
	mv labels.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/cv_data/normy/lstm/seq2/labels.npy
	...
	python main.py -mm="ram" --debug=1 -pl 5 -po 4 -ts 0 -tnl 90 -bs=15000 --batch_size=1000 --filters=256 -m="lstm" --phase="train" -sc=True --class_n=8 --log_dir="../data/summaries/" --path="../hn_data/" --im_h=6231 --im_w=4548 --band_n=2 --t_len=24 --id_first=1 -psv=False -tof=False --epoch=200 -nap=2 -tmd="False" -tfld="/home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/normy/test_patches/" 
	mv predicted.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/normy/lstm/predicted.npy
	mv labels.npy /home/lvc/Jorg/deep_learning/LSTM-Final-Project/hn_data/normy/lstm/labels.npy
fi
if [ $mode -eq 5 ]; then
